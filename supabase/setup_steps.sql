...
-- ===================================
-- Chạy phần này nếu bạn muốn reset toàn bộ
...
-- ===================================
-- BƯỚC 5: TẠO PROFILE CHO USER CŨ (NẾU CÓ)
-- ===================================
-- Chỉ chạy phần này sau khi đã tạo bảng profiles thành công
